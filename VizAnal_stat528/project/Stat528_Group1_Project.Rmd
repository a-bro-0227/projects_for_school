...
As expected, there are way more dogs than anything else. Because of the large percentage of dogs compared to every other animal type, it will be worth taking a closer look at dogs specifically. We will save a data set called `dallas_dogs` which contains only the animal type `DOG`.
